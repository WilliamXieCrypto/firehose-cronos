...
function main() {
  ...
  generate "sf/cronos/type/v1/type.proto"
  ...
  echo "streamingfast/firehose-cronos/proto revision: `GIT_DIR=$ROOT/.git git log -n 1 --pretty=format:%h -- proto`" >> ./last_generate.txt
}
